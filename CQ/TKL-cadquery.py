...
kb = keyboard(
    ...
    outlineLocations = [
        {"position": primitives.point( 14, -0.375), "isDrill": True,  "convex": True,  "offsetByHandAngle": False}, # Top right of board
        {"position": primitives.point( -0.375, -0.375), "isDrill": True,  "convex": True,  "offsetByHandAngle": False}, # Top left of board
        {"position": primitives.point( -0.375, 9.375), "isDrill": True,  "convex": True,  "offsetByHandAngle": False}, # Bottom left of board
        {"position": primitives.point( 14, 9.375), "isDrill": True,  "convex": True,  "offsetByHandAngle": False}, # Bottom right of board
